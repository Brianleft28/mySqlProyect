...
--
-- Table structure for table `payments_datails`
--

DROP TABLE IF EXISTS `payments_datails`;
...
CREATE TABLE `payments_datails` (
  ...
  KEY `paymentsdetails_customers_fk` (`id_client`),
  CONSTRAINT `paymentsdetails_customers_fk` FOREIGN KEY (`id_client`) REFERENCES `customers` (`id_client`) ON DELETE CASCADE ON UPDATE CASCADE
