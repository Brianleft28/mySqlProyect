...
CREATE TABLE `new_cars` (
  ...
  PRIMARY KEY (`id_car`),
  CONSTRAINT `INVENTORY_NEWCARS` FOREIGN KEY (`id_car`) REFERENCES `inventory` (`id_car`),
  CONSTRAINT `supplier_newcars_fk` FOREIGN KEY (`id_car`) REFERENCES `suppliers` (`id_car`) ON DELETE CASCADE ON UPDATE CASCADE
