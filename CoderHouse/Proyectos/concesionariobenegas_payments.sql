...
CREATE TABLE `payments` (
  ...
  `Value_model` int DEFAULT NULL,
  `id_car` int NOT NULL,
  PRIMARY KEY (`id_payments`),
  KEY `payments_customers_fk` (`id_client`),
  CONSTRAINT `payments_customers_fk` FOREIGN KEY (`id_client`) REFERENCES `customers` (`id_client`) ON DELETE CASCADE ON UPDATE CASCADE
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `validar_stockCars` BEFORE INSERT ON `payments` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_available_newcars` AFTER INSERT ON `payments` FOR EACH ROW BEGIN
  UPDATE inventory 
